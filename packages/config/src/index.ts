...
export const envSchema = z
  ...
  .superRefine((env, context) => {
    ...
    // Le mode Postiz réel publie vraiment sur les comptes d’un client : il refuse de
    // démarrer tant que ses quatre conditions ne sont pas réunies, plutôt que de laisser
    // une instance à moitié configurée toucher des comptes sociaux.
